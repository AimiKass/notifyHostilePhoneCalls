...
public class SettingsArrayAdapter extends ArrayAdapter<SettingsArrayAdapter.Model>
{
    ...
    private void addModel(int type, String title, String comment, String property, boolean isChecked, View.OnClickListener listener)
    {
        Model model = new Model(type, title, comment, property, isChecked, listener);
        add(model);
    }

    private void addModel(int type, String title, String comment, String property, View.OnClickListener listener)
    {
    ...
    public void addCheckbox(@StringRes int titleId, @StringRes int commentId, boolean isChecked, View.OnClickListener listener)
    {
        addModel(Model.CHECKBOX, getString(titleId), getString(commentId), null, isChecked, listener);
    }

    public void addCheckbox(@StringRes int titleId, @StringRes int commentId, String property, View.OnClickListener listener)
    {
    ...
    class Model
    {
        ...
        Model(int type, String title, String comment, String property, boolean checked, View.OnClickListener listener)
        {
            this.type = type;
            this.title = title;
        ...
        boolean setChecked(boolean checked)
        {
            ...
            {
                if (property != null && !Settings.setBooleanValue(getContext(), property, checked))
                {
                    return false;
                }
                this.checked = checked;
