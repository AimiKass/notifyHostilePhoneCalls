...
public class DBIncomingCallsHandler extends SQLiteOpenHelper
{

    // creating a constant variables for our database.
    // below variable is for our database name.
    private static final String DB_NAME_FOR_INCOMING_CALLS = "hostilePhoneCalls_db";

    // below int is our database version
    private static final int DB_VERSION = 1;

    // below variable is for our table name.
    private static final String TABLE_INCOMING_CALLS_NAME = "hostiliePhoneNumbers";
    ...
    public DBIncomingCallsHandler(Context context)
    {
        super(context, DB_NAME_FOR_INCOMING_CALLS, null, DB_VERSION);
    }
    ...
    public void onCreate(SQLiteDatabase db)
    {
        ...
        String query = "CREATE TABLE " + TABLE_INCOMING_CALLS_NAME + " (" + ID_COL + " INTEGER PRIMARY KEY AUTOINCREMENT, " + NUMBER_COL + " TEXT," + RATING_COL + " TEXT)";
    ...
    public void addPhoneNumber(String phoneNumber, String rating)
    {
        ...
        db.insert(TABLE_INCOMING_CALLS_NAME, null, values);
    ...
    public ArrayList<PhoneNumber> getAllNumbers()
    {
        ...
        Cursor cursorCourses = db.rawQuery("SELECT * FROM " + TABLE_INCOMING_CALLS_NAME, null);
    ...
    public void updatePhoneNumber(String originalCourseName, String phoneNumber, String rating)
    {
        ...
        db.update(TABLE_INCOMING_CALLS_NAME, values, "number=?", new String[]{originalCourseName});
        db.close();
    }
    ...
    public void deletePhoneNumber(String courseName)
    {
        ...
        db.delete(TABLE_INCOMING_CALLS_NAME, "number=?", new String[]{courseName});
        db.close();
    }
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion)
    {
        ...
        db.execSQL("DROP TABLE IF EXISTS " + TABLE_INCOMING_CALLS_NAME);
        onCreate(db);
    }
}
