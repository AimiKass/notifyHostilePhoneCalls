...
public class DBHandler extends SQLiteOpenHelper {
    ...
    private static final String DB_NAME = "hostilePhoneCalls_db";

    // below int is our database version
    private static final int DB_VERSION = 1;

    // below variable is for our table name.
    private static final String TABLE_NAME = "hostiliePhoneNumbers";
    ...
    public ArrayList<PhoneNumber> getAllNumbers() {
        ...
        if (cursorCourses.moveToFirst()) {
            do {
                ...
                courseModalArrayList.add(new PhoneNumber(cursorCourses.getString(1),
    ...
    public void updatePhoneNumber(String originalCourseName, String phoneNumber, String rating) {
        ...
        db.update(TABLE_NAME, values, "number=?", new String[]{originalCourseName});
        db.close();
    }
    ...
    public void deletePhoneNumber(String courseName) {
        ...
        db.delete(TABLE_NAME, "number=?", new String[]{courseName});
        db.close();
    }
